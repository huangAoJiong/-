...
import firecrackerBoomNormalAudio from '../assets/firecracker-boom-normal.mp3'
import firecrackerBoomBigAudio from '../assets/firecracker-boom-big.mp3'
...
export default class Firecracker {
    ...
    constructor(size: FirecrackerSize = 'normal') {
        this.disposed = false
        this.ignited = false
        this.size = size
        this.container = new Group({
            scaleX: this.size === 'normal' ? 1 : 1.5,
            scaleY: this.size === 'normal' ? 1 : 1.5
        })
        this.body = new Image({
            style: {
        ...
        this.audioPlayer.src = this.size === 'normal' ? firecrackerBoomNormalAudio : firecrackerBoomBigAudio
    }
...
type FirecrackerSize = 'normal' | 'big'